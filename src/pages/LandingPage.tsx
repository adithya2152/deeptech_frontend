      ...
      <section className="relative overflow-hidden bg-background pt-16 pb-24 lg:pt-11">
        ...
        <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center animate-in fade-in slide-in-from-top-4 duration-1000">
            ...
            {/* Tagline Formula */}
            <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-sm sm:text-lg font-medium text-muted-foreground bg-muted/50 px-4 sm:px-6 py-3 rounded-full border border-border/50 mb-8">
