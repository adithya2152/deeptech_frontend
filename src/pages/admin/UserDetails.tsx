...
import { ArrowLeft, Mail, Calendar, MapPin, DollarSign, ShieldCheck, Ban, AlertTriangle, Briefcase, FileSignature, Clock } from 'lucide-react';
...
export default function UserDetails() {
    ...
    const contractColumns = [
        ...
        {
            header: 'Project',
            accessorKey: 'project_title' as const,
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="ml-auto flex gap-2">
                        {isExpert && user.vetting_status === 'pending' && !user.is_banned && (
                                    ...
                                    <div className="flex justify-between items-start">
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2 mt-1">
                                                ...
                                                {isExpert && user.vetting_status === 'approved' && (
                                                    <Badge className="bg-emerald-50 text-emerald-700 border-emerald-200">Verified Expert</Badge>
                                                )}
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <TabsContent value="activity" className="mt-4">
                        <Card>
                            <CardContent className="p-8 text-center text-zinc-500">
                                ...
                                <p>Detailed activity log feature coming soon.</p>
                            </CardContent>
                        </Card>
                    </TabsContent>
                </Tabs>
