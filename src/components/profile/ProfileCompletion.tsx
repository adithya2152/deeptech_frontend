...
export function ProfileCompletion({ formData, isExpert, onEditSection, expertStatus }: ProfileCompletionProps) {
  ...
  const criteria = [
    ...
    { label: 'Expertise Domains', filled: formData.domains && formData.domains.length > 0, weight: 15, required: true },
    { label: 'Specific Skills', filled: formData.skills && formData.skills.length > 0, weight: 15, required: true },
    { label: 'Hourly Rates', filled: formData.avg_daily_rate > 0 || formData.avg_sprint_rate > 0, weight: 15, required: true },
    { label: 'Years of Experience', filled: formData.years_experience > 0, weight: 10, required: true },
    { label: 'Languages', filled: formData.languages && formData.languages.length > 0, weight: 10, required: true },
    
    { label: 'Portfolio / Website', filled: !!formData.portfolio_url, weight: 0, required: false },
    { label: 'Credentials (IP/Papers)', filled: hasCredentials, weight: 0, required: false },
  ];
