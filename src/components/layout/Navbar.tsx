...
export function Navbar() {
  const { user, profile, isAuthenticated, token, logout } = useAuth();
  ...
  // Fetch expert data to check verification status
  ...
  // Prioritize profile avatar from context, fallback to user object
                ...
                {isExpert && (
                  <>
                    <button
                      ...
                      onClick={() => canUseExpertApp && navigate("/marketplace")}
                    >
                      Find Work
                    </button>
            ...
            {isAuthenticated ? (
              ...
              <>
                ...
                <div className="pt-3 flex flex-col gap-2">
                  ...
                  <Button className="w-full gradient-primary" onClick={() => { navigate('/register'); setMobileMenuOpen(false); }}>
                    Get Started
                  </Button>
                </div>
              </>
